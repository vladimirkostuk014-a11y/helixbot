                    ...
                    <div className="space-y-4 relative z-10 flex-1">
                        ...
                        {config.aiProfanity && (
                            <div className="bg-red-900/10 p-4 rounded-xl border border-red-900/30">
                                <label className="text-xs text-red-400 font-bold uppercase mb-2 block flex justify-between">
                                    <span>Уровень жесткости мата</span>
                                    <span>{config.aiProfanityLevel || 50}%</span>
                                </label>
                                <input 
                                    type="range" 
                                    min="10" 
                                    max="100" 
                                    step="10"
                                    value={config.aiProfanityLevel || 50} 
                                    onChange={e => setConfig({...config, aiProfanityLevel: parseInt(e.target.value)})}
